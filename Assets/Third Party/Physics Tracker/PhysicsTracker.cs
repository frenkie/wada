...
namespace Unity.Labs.SuperScience
{
    ...
    public class PhysicsTracker
    {
        ...
        public void Reset(Vector3 currentPosition, Quaternion currentRotation, Vector3 currentVelocity,
        ...
        public void Update(Vector3 newPosition, Quaternion newRotation, float timeSlice)
        {
            ...
            {
                var overTimeScalar =
                    Mathf.Clamp01( (k_PredictedPeriod - combinedSample.time) / m_Samples[sampleIndex].time );
