...
using AwesomeTechnologies.VegetationSystem.Biomes;
    ...
    public class RamSpline : MonoBehaviour, IVertexPaintable, ITerrainPainterGetData, IGenerationEvents
    {
        ...
        private void GenerateMesh(ref Mesh mesh)
        {
            ...
            //RamVertexColors.GetLakesBlend(meshRenderer);
            ...
            for (int i = 0; i < NmSpline.PointsDown.Count; i++)
            {
                ...
                for (int j = 0; j < BaseProfile.vertsInShape * NmSpline.Points[i].Density; j++)
                {
                    int id = offsetVert;
            ...
            colors = RamVertexColors.ManageVertexColors(colors, normals, vertCount);
