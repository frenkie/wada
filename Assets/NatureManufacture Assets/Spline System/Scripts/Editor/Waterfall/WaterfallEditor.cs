...
namespace NatureManufacture.RAM.Editor
{
    ...
    public class WaterfallEditor : Editor
    {
        ...
        private const string TooltipBlurStrength = "This is the blur strength of the waterfall.";
        private const string TooltipBlurIterations = "This is the number of blur iterations for the waterfall.";
        private const string TooltipBlurSize = "This is the blur size for the waterfall.";
        ...
        private void UISplineSettings()
        {
            ...
            _waterfall.BaseProfile.TimeStep = EditorGUILayout.Slider(new GUIContent("Time step", TooltipTimeStep), _waterfall.BaseProfile.TimeStep, 0.001f, 10f);
            EditorGUILayout.Space();
            ...
            EditorGUILayout.Space();
            _waterfall.BaseProfile.BlurIterations = EditorGUILayout.IntField(new GUIContent("Blur iterations", TooltipBlurIterations), _waterfall.BaseProfile.BlurIterations);
            _waterfall.BaseProfile.BlurStrength = EditorGUILayout.FloatField(new GUIContent("Blur strength", TooltipBlurStrength), _waterfall.BaseProfile.BlurStrength);
            _waterfall.BaseProfile.BlurSize = EditorGUILayout.IntField(new GUIContent("Blur size", TooltipBlurSize), _waterfall.BaseProfile.BlurSize);
            ...
            EditorGUILayout.Space();
            _waterfall.BaseProfile.TerrainOffset = EditorGUILayout.FloatField(new GUIContent("Terrain offset", TooltipTerrainOffset), _waterfall.BaseProfile.TerrainOffset);
