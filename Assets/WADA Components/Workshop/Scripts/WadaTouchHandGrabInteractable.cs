...
namespace Wada
{
    ...
    /// </summary>
    public class
        WadaTouchHandGrabInteractable : PointerInteractable<WadaTouchHandGrabInteractor, WadaTouchHandGrabInteractable>
    {
        ...
        void InjectBoundsCollider(Collider boundsCollider)
        {
